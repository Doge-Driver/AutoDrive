...
class CalibrateRobertson(CalibrateCRF):
    # no doc
    def getMaxIter(self): # real signature unknown; restored from __doc__
        """
        getMaxIter() -> retval
        .
        """
    ...
    def getRadiance(self): # real signature unknown; restored from __doc__
        """
        getRadiance() -> retval
        .
        """
    ...
    def setMaxIter(self, max_iter): # real signature unknown; restored from __doc__
        """
