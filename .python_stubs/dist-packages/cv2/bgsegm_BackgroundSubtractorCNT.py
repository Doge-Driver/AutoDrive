...
class bgsegm_BackgroundSubtractorCNT(BackgroundSubtractor):
    ...
    def getIsParallel(self): # real signature unknown; restored from __doc__
        """
    ...
    def getMaxPixelStability(self): # real signature unknown; restored from __doc__
        """
    ...
    def getMinPixelStability(self): # real signature unknown; restored from __doc__
        """
    ...
    def getUseHistory(self): # real signature unknown; restored from __doc__
        """
    ...
    def setIsParallel(self, value): # real signature unknown; restored from __doc__
        """
    ...
    def setMaxPixelStability(self, value): # real signature unknown; restored from __doc__
        """
    ...
    def setMinPixelStability(self, value): # real signature unknown; restored from __doc__
        """
    ...
    def setUseHistory(self, value): # real signature unknown; restored from __doc__
        """
