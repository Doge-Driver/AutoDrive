...
from .face_PredictCollector import face_PredictCollector

class face_StandardCollector(face_PredictCollector):
    # no doc
    def create(self, threshold=None): # real signature unknown; restored from __doc__
        """
    ...
    def getMinLabel(self): # real signature unknown; restored from __doc__
        """
        getMinLabel() -> retval
    ...
    def getResults(self, sorted=None): # real signature unknown; restored from __doc__
        """
