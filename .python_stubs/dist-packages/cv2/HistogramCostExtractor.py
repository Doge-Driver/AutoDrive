...
class HistogramCostExtractor(Algorithm):
    # no doc
    def buildCostMatrix(self, descriptors1, descriptors2, costMatrix=None): # real signature unknown; restored from __doc__
        """
    ...
    def getDefaultCost(self): # real signature unknown; restored from __doc__
        """
    ...
    def getNDummies(self): # real signature unknown; restored from __doc__
        """
        getNDummies() -> retval
        .
        """
    ...
    def setDefaultCost(self, defaultCost): # real signature unknown; restored from __doc__
        """
    ...
    def setNDummies(self, nDummies): # real signature unknown; restored from __doc__
        """
