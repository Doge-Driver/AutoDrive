...
class dnn_DictValue(object):
    # no doc
    def getIntValue(self, idx=None): # real signature unknown; restored from __doc__
        """
    ...
    def getRealValue(self, idx=None): # real signature unknown; restored from __doc__
        """
    ...
    def getStringValue(self, idx=None): # real signature unknown; restored from __doc__
        """
