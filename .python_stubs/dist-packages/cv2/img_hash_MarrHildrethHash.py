...
class img_hash_MarrHildrethHash(img_hash_ImgHashBase):
    # no doc
    def create(self, alpha=None, scale=None): # real signature unknown; restored from __doc__
        """
    ...
    def setKernelParam(self, alpha, scale): # real signature unknown; restored from __doc__
        """
