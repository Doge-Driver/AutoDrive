...
class phase_unwrapping_PhaseUnwrapping(object):
    # no doc
    def unwrapPhaseMap(self, wrappedPhaseMap, unwrappedPhaseMap=None, shadowMask=None): # real signature unknown; restored from __doc__
        """
