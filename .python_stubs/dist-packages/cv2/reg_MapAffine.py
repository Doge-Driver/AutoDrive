...
class reg_MapAffine(reg_Map):
    # no doc
    def compose(self, map): # real signature unknown; restored from __doc__
        """
        compose(map) -> None
        .
        """
    ...
    def getLinTr(self, linTr=None): # real signature unknown; restored from __doc__
        """
    ...
    def getShift(self, shift=None): # real signature unknown; restored from __doc__
        """
    ...
    def inverseMap(self): # real signature unknown; restored from __doc__
        """
        inverseMap() -> retval
        .
        """
    ...
    def inverseWarp(self, img1, img2=None): # real signature unknown; restored from __doc__
        """
