...
def calcOpticalFlowDenseRLOF(I0, I1, flow, rlofParam=None, forwardBackwardThreshold=None, gridStep=None, interp_type=None, epicK=None, epicSigma=None, epicLambda=None, ricSPSize=None, ricSLICType=None, use_post_proc=None, fgsLambda=None, fgsSigma=None, use_variational_refinement=None): # real signature unknown; restored from __doc__
    """
...
def DenseRLOFOpticalFlow_create(rlofParam=None, forwardBackwardThreshold=None, gridStep=None, interp_type=None, epicK=None, epicSigma=None, epicLambda=None, ricSPSize=None, ricSLICType=None, use_post_proc=None, fgsLambda=None, fgsSigma=None, use_variational_refinement=None): # real signature unknown; restored from __doc__
    """
