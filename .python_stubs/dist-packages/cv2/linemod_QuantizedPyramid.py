...
class linemod_QuantizedPyramid(object):
    # no doc
    def extractTemplate(self): # real signature unknown; restored from __doc__
        """
    ...
    def pyrDown(self): # real signature unknown; restored from __doc__
        """
        pyrDown() -> None
    ...
    def quantize(self, dst=None): # real signature unknown; restored from __doc__
        """
        quantize([, dst]) -> dst
