...
class reg_MapperPyramid(reg_Mapper):
    # no doc
    def calculate(self, img1, img2, init=None): # real signature unknown; restored from __doc__
        """
    ...
    def getMap(self): # real signature unknown; restored from __doc__
        """
        getMap() -> retval
        .
        """
    ...
    numIterPerScale_ = property(lambda self: object(), lambda self, v: None, lambda self: None)  # default
    """numIterPerScale_"""

    numLev_ = property(lambda self: object(), lambda self, v: None, lambda self: None)  # default
    """numLev_"""
