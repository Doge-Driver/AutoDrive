...
def RgbdPlane_create(method, block_size, min_size, threshold, sensor_error_a=None, sensor_error_b=None, sensor_error_c=None): # real signature unknown; restored from __doc__
    """
    RgbdPlane_create(method, block_size, min_size, threshold[, sensor_error_a[, sensor_error_b[, sensor_error_c]]]) -> retval
    .   Constructor
