...
from .detail_ProjectorBase import detail_ProjectorBase

class detail_SphericalProjector(detail_ProjectorBase):
    # no doc
    def mapBackward(self, u, v, x, y): # real signature unknown; restored from __doc__
        """
    ...
    def mapForward(self, x, y, u, v): # real signature unknown; restored from __doc__
        """
