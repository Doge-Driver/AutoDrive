...
class optflow_DenseRLOFOpticalFlow(DenseOpticalFlow):
    # no doc
    def create(self, rlofParam=None, forwardBackwardThreshold=None, gridStep=None, interp_type=None, epicK=None, epicSigma=None, epicLambda=None, ricSPSize=None, ricSLICType=None, use_post_proc=None, fgsLambda=None, fgsSigma=None, use_variational_refinement=None): # real signature unknown; restored from __doc__
        """
        create([, rlofParam[, forwardBackwardThreshold[, gridStep[, interp_type[, epicK[, epicSigma[, epicLambda[, ricSPSize[, ricSLICType[, use_post_proc[, fgsLambda[, fgsSigma[, use_variational_refinement]]]]]]]]]]]]]) -> retval
    ...
    def getRICSLICType(self): # real signature unknown; restored from __doc__
        """
        getRICSLICType() -> retval
        .   @copybrief setRICSLICType
        .        *    @see setRICSLICType
        """
        pass

    def getRICSPSize(self): # real signature unknown; restored from __doc__
        """
        getRICSPSize() -> retval
    ...
    def setRICSLICType(self, val): # real signature unknown; restored from __doc__
        """
        setRICSLICType(val) -> None
    ...
    def setRICSPSize(self, val): # real signature unknown; restored from __doc__
        """
        setRICSPSize(val) -> None
        .   * @see cv::ximgproc::createSuperpixelSLIC, cv::ximgproc::RICInterpolator
        """
        pass
    ...
    def setUseVariationalRefinement(self, val): # real signature unknown; restored from __doc__
        """
        setUseVariationalRefinement(val) -> None
