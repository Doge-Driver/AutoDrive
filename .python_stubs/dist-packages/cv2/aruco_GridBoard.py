...
from .aruco_Board import aruco_Board

class aruco_GridBoard(aruco_Board):
    # no doc
    def create(self, markersX, markersY, markerLength, markerSeparation, dictionary, firstMarker=None): # real signature unknown; restored from __doc__
        """
    ...
    def getGridSize(self): # real signature unknown; restored from __doc__
        """
        getGridSize() -> retval
        .   *
        """
    ...
    def getMarkerSeparation(self): # real signature unknown; restored from __doc__
        """
