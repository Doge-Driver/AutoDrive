...
class img_hash_ImgHashBase(object):
    # no doc
    def compare(self, hashOne, hashTwo): # real signature unknown; restored from __doc__
        """
    ...
    def compute(self, inputArr, outputArr=None): # real signature unknown; restored from __doc__
        """
