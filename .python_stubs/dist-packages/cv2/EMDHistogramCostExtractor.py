...
from .HistogramCostExtractor import HistogramCostExtractor

class EMDHistogramCostExtractor(HistogramCostExtractor):
    # no doc
    def getNormFlag(self): # real signature unknown; restored from __doc__
        """
        getNormFlag() -> retval
        .
        """
    ...
    def setNormFlag(self, flag): # real signature unknown; restored from __doc__
        """
