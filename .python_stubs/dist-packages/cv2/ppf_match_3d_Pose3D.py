...
class ppf_match_3d_Pose3D(object):
    # no doc
    def appendPose(self, IncrementalPose): # real signature unknown; restored from __doc__
        """
    ...
    def printPose(self): # real signature unknown; restored from __doc__
        """
        printPose() -> None
        .
        """
    ...
    def updatePose(self, NewPose): # real signature unknown; restored from __doc__
        """
    ...
    def updatePoseQuat(self, Q, NewT): # real signature unknown; restored from __doc__
        """
    ...
    numVotes = property(lambda self: object(), lambda self, v: None, lambda self: None)  # default
    """numVotes"""

    pose = property(lambda self: object(), lambda self, v: None, lambda self: None)  # default
    """pose"""

    q = property(lambda self: object(), lambda self, v: None, lambda self: None)  # default
    """q"""
