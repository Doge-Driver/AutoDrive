...
class face_BIF(Algorithm):
    # no doc
    def compute(self, image, features=None): # real signature unknown; restored from __doc__
        """
    ...
    def create(self, num_bands=None, num_rotations=None): # real signature unknown; restored from __doc__
        """
    ...
    def getNumBands(self): # real signature unknown; restored from __doc__
        """
        getNumBands() -> retval
    ...
    def getNumRotations(self): # real signature unknown; restored from __doc__
        """
