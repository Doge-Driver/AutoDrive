...
from .detail_Blender import detail_Blender
...
class detail_FeatherBlender(detail_Blender):
    ...
    def createWeightMaps(self, masks, corners, weight_maps): # real signature unknown; restored from __doc__
        """
    ...
    def prepare(self, dst_roi): # real signature unknown; restored from __doc__
        """
    ...
    def setSharpness(self, val): # real signature unknown; restored from __doc__
        """
    ...
    def sharpness(self): # real signature unknown; restored from __doc__
        """
        sharpness() -> retval
        .
        """
