...
class ximgproc_DisparityFilter(Algorithm):
    # no doc
    def filter(self, disparity_map_left, left_view, filtered_disparity_map=None, disparity_map_right=None, ROI=None, right_view=None): # real signature unknown; restored from __doc__
        """
