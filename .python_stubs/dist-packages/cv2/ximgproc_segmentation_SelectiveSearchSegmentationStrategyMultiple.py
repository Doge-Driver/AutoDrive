...
from .ximgproc_segmentation_SelectiveSearchSegmentationStrategy import ximgproc_segmentation_SelectiveSearchSegmentationStrategy
...
class ximgproc_segmentation_SelectiveSearchSegmentationStrategyMultiple(ximgproc_segmentation_SelectiveSearchSegmentationStrategy):
    # no doc
    def addStrategy(self, g, weight): # real signature unknown; restored from __doc__
        """
