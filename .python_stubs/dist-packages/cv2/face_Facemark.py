...
class face_Facemark(object):
    # no doc
    def fit(self, image, faces, landmarks=None): # real signature unknown; restored from __doc__
        """
    ...
    def loadModel(self, model): # real signature unknown; restored from __doc__
        """
