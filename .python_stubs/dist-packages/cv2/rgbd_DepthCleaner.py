...
class rgbd_DepthCleaner(Algorithm):
    # no doc
    def apply(self, points, depth=None): # real signature unknown; restored from __doc__
        """
    ...
    def create(self, depth, window_size=None, method=None): # real signature unknown; restored from __doc__
        """
