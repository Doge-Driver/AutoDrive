...
class ppf_match_3d_PPF3DDetector(object):
    # no doc
    def match(self, scene, relativeSceneSampleStep=None, relativeSceneDistance=None): # real signature unknown; restored from __doc__
        """
    ...
    def trainModel(self, Model): # real signature unknown; restored from __doc__
        """
