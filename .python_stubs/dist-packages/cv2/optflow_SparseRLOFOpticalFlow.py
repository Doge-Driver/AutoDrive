...
class optflow_SparseRLOFOpticalFlow(SparseOpticalFlow):
    # no doc
    def create(self, rlofParam=None, forwardBackwardThreshold=None): # real signature unknown; restored from __doc__
        """
        create([, rlofParam[, forwardBackwardThreshold]]) -> retval
