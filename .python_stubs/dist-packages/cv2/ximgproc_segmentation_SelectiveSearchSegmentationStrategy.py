...
class ximgproc_segmentation_SelectiveSearchSegmentationStrategy(Algorithm):
    # no doc
    def get(self, r1, r2): # real signature unknown; restored from __doc__
        """
        get(r1, r2) -> retval
    ...
    def merge(self, r1, r2): # real signature unknown; restored from __doc__
        """
        merge(r1, r2) -> None
    ...
    def setImage(self, img, regions, sizes, image_id=None): # real signature unknown; restored from __doc__
        """
