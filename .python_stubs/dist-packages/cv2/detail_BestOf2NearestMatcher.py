...
from .detail_FeaturesMatcher import detail_FeaturesMatcher
...
class detail_BestOf2NearestMatcher(detail_FeaturesMatcher):
    ...
    def create(self, try_use_gpu=None, match_conf=None, num_matches_thresh1=None, num_matches_thresh2=None): # real signature unknown; restored from __doc__
        """
