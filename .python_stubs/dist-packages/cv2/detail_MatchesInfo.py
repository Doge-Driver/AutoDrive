...
class detail_MatchesInfo(object):
    # no doc
    def getInliers(self): # real signature unknown; restored from __doc__
        """
        getInliers() -> retval
        .
        """
    ...
    def getMatches(self): # real signature unknown; restored from __doc__
        """
        getMatches() -> retval
        .
        """
    ...
    dst_img_idx = property(lambda self: object(), lambda self, v: None, lambda self: None)  # default
    """dst_img_idx"""

    H = property(lambda self: object(), lambda self, v: None, lambda self: None)  # default
    """H"""

    num_inliers = property(lambda self: object(), lambda self, v: None, lambda self: None)  # default
    """num_inliers"""

    src_img_idx = property(lambda self: object(), lambda self, v: None, lambda self: None)  # default
    """src_img_idx"""
