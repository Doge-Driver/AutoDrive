...
class cuda_BufferPool(object):
    # no doc
    def getAllocator(self): # real signature unknown; restored from __doc__
        """
        getAllocator() -> retval
        .
        """
    ...
    def getBuffer(self, rows, cols, type): # real signature unknown; restored from __doc__
        """
