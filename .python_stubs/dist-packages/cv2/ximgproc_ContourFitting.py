...
class ximgproc_ContourFitting(Algorithm):
    # no doc
    def estimateTransformation(self, src, dst, alphaPhiST=None, fdContour=None): # real signature unknown; restored from __doc__
        """
    ...
    def getCtrSize(self): # real signature unknown; restored from __doc__
        """
        getCtrSize() -> retval
    ...
    def getFDSize(self): # real signature unknown; restored from __doc__
        """
        getFDSize() -> retval
    ...
    def setCtrSize(self, n): # real signature unknown; restored from __doc__
        """
        setCtrSize(n) -> None
    ...
    def setFDSize(self, n): # real signature unknown; restored from __doc__
        """
        setFDSize(n) -> None
