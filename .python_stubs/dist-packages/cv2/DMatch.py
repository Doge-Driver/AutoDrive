...
class DMatch(object):
    ...
    imgIdx = property(lambda self: object(), lambda self, v: None, lambda self: None)  # default
    """imgIdx"""

    queryIdx = property(lambda self: object(), lambda self, v: None, lambda self: None)  # default
    """queryIdx"""

    trainIdx = property(lambda self: object(), lambda self, v: None, lambda self: None)  # default
    """trainIdx"""
