...
class rgbd_Odometry(Algorithm):
    # no doc
    def compute(self, srcImage, srcDepth, srcMask, dstImage, dstDepth, dstMask, Rt=None, initRt=None): # real signature unknown; restored from __doc__
        """
    ...
    def compute2(self, srcFrame, dstFrame, Rt=None, initRt=None): # real signature unknown; restored from __doc__
        """
    ...
    def DEFAULT_MAX_DEPTH(self): # real signature unknown; restored from __doc__
        """
    ...
    def DEFAULT_MAX_DEPTH_DIFF(self): # real signature unknown; restored from __doc__
        """
    ...
    def DEFAULT_MAX_POINTS_PART(self): # real signature unknown; restored from __doc__
        """
    ...
    def DEFAULT_MAX_ROTATION(self): # real signature unknown; restored from __doc__
        """
    ...
    def DEFAULT_MAX_TRANSLATION(self): # real signature unknown; restored from __doc__
        """
