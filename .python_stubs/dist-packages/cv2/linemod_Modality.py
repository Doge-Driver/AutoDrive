...
class linemod_Modality(object):
    # no doc
    def create(self, modality_type): # real signature unknown; restored from __doc__
        """
    ...
    def process(self, src, mask=None): # real signature unknown; restored from __doc__
        """
