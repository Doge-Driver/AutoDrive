...
class detail_Timelapser(object):
    # no doc
    ...
    def getDst(self): # real signature unknown; restored from __doc__
        """
        getDst() -> retval
        .
        """
    ...
    def initialize(self, corners, sizes): # real signature unknown; restored from __doc__
        """
    ...
    def process(self, img, mask, tl): # real signature unknown; restored from __doc__
        """
