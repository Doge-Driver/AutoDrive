...
from .ShapeTransformer import ShapeTransformer

class ThinPlateSplineShapeTransformer(ShapeTransformer):
    # no doc
    def getRegularizationParameter(self): # real signature unknown; restored from __doc__
        """
    ...
    def setRegularizationParameter(self, beta): # real signature unknown; restored from __doc__
        """
