...
class aruco_Board(object):
    # no doc
    def create(self, objPoints, dictionary, ids): # real signature unknown; restored from __doc__
        """
    ...
    objPoints = property(lambda self: object(), lambda self, v: None, lambda self: None)  # default
    """objPoints"""
