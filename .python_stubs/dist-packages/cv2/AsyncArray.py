...
class AsyncArray(object):
    # no doc
    def get(self, dst=None): # real signature unknown; restored from __doc__
        """
        get([, dst]) -> dst
        .   Fetch the result.
    ...
    def wait_for(self, timeoutNs): # real signature unknown; restored from __doc__
        """
