...
class rgbd_ICPOdometry(rgbd_Odometry):
    # no doc
    def create(self, cameraMatrix=None, minDepth=None, maxDepth=None, maxDepthDiff=None, maxPointsPart=None, iterCounts=None, transformType=None): # real signature unknown; restored from __doc__
        """
