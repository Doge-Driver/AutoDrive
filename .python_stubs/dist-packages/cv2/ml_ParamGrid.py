...
class ml_ParamGrid(object):
    # no doc
    def create(self, minVal=None, maxVal=None, logstep=None): # real signature unknown; restored from __doc__
        """
    ...
    logStep = property(lambda self: object(), lambda self, v: None, lambda self: None)  # default
    """logStep"""

    maxVal = property(lambda self: object(), lambda self, v: None, lambda self: None)  # default
    """maxVal"""

    minVal = property(lambda self: object(), lambda self, v: None, lambda self: None)  # default
    """minVal"""
