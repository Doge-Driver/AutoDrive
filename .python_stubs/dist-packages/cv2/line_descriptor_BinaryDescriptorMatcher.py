...
class line_descriptor_BinaryDescriptorMatcher(Algorithm):
    ...
    def knnMatchQuery(self, queryDescriptors, matches, k, masks=None, compactResult=None): # real signature unknown; restored from __doc__
        """
    ...
    def matchQuery(self, queryDescriptors, masks=None): # real signature unknown; restored from __doc__
        """
