...
from .saliency_MotionSaliency import saliency_MotionSaliency
...
class saliency_MotionSaliencyBinWangApr2014(saliency_MotionSaliency):
    ...
    def getImageHeight(self): # real signature unknown; restored from __doc__
        """
    ...
    def getImageWidth(self): # real signature unknown; restored from __doc__
        """
    ...
    def setImageHeight(self, val): # real signature unknown; restored from __doc__
        """
    ...
    def setImagesize(self, W, H): # real signature unknown; restored from __doc__
        """
    ...
    def setImageWidth(self, val): # real signature unknown; restored from __doc__
        """
