...
class MultiTracker(Algorithm):
    # no doc
    def add(self, newTracker, image, boundingBox): # real signature unknown; restored from __doc__
        """
    ...
    def update(self, image): # real signature unknown; restored from __doc__
        """
