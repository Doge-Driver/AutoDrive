...
from .text_TextDetector import text_TextDetector

class text_TextDetectorCNN(text_TextDetector):
    # no doc
    def create(self, modelArchFilename, modelWeightsFilename): # real signature unknown; restored from __doc__
        """
    ...
    def detect(self, inputImage): # real signature unknown; restored from __doc__
        """
