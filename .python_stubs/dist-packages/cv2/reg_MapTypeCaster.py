...
class reg_MapTypeCaster(object):
    # no doc
    def toAffine(self, sourceMap): # real signature unknown; restored from __doc__
        """
    ...
    def toProjec(self, sourceMap): # real signature unknown; restored from __doc__
        """
    ...
    def toShift(self, sourceMap): # real signature unknown; restored from __doc__
        """
