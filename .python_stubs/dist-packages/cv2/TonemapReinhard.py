...
class TonemapReinhard(Tonemap):
    # no doc
    def getColorAdaptation(self): # real signature unknown; restored from __doc__
        """
    ...
    def getIntensity(self): # real signature unknown; restored from __doc__
        """
        getIntensity() -> retval
        .
        """
    ...
    def getLightAdaptation(self): # real signature unknown; restored from __doc__
        """
    ...
    def setColorAdaptation(self, color_adapt): # real signature unknown; restored from __doc__
        """
    ...
    def setIntensity(self, intensity): # real signature unknown; restored from __doc__
        """
    ...
    def setLightAdaptation(self, light_adapt): # real signature unknown; restored from __doc__
        """
