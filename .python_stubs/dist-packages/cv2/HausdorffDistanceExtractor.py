...
class HausdorffDistanceExtractor(ShapeDistanceExtractor):
    # no doc
    def getDistanceFlag(self): # real signature unknown; restored from __doc__
        """
    ...
    def getRankProportion(self): # real signature unknown; restored from __doc__
        """
    ...
    def setDistanceFlag(self, distanceFlag): # real signature unknown; restored from __doc__
        """
    ...
    def setRankProportion(self, rankProportion): # real signature unknown; restored from __doc__
        """
