...
from .img_hash_ImgHashBase import img_hash_ImgHashBase

class img_hash_RadialVarianceHash(img_hash_ImgHashBase):
    # no doc
    def create(self, sigma=None, numOfAngleLine=None): # real signature unknown; restored from __doc__
        """
    ...
    def getNumOfAngleLine(self): # real signature unknown; restored from __doc__
        """
    ...
    def setNumOfAngleLine(self, value): # real signature unknown; restored from __doc__
        """
    ...
    def setSigma(self, value): # real signature unknown; restored from __doc__
        """
        setSigma(value) -> None
        .
        """
