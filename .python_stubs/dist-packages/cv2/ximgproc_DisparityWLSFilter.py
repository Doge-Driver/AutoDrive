...
from .ximgproc_DisparityFilter import ximgproc_DisparityFilter

class ximgproc_DisparityWLSFilter(ximgproc_DisparityFilter):
    # no doc
    def getConfidenceMap(self): # real signature unknown; restored from __doc__
        """
    ...
    def getDepthDiscontinuityRadius(self): # real signature unknown; restored from __doc__
        """
    ...
    def getLRCthresh(self): # real signature unknown; restored from __doc__
        """
        getLRCthresh() -> retval
    ...
    def getROI(self): # real signature unknown; restored from __doc__
        """
        getROI() -> retval
    ...
    def getSigmaColor(self): # real signature unknown; restored from __doc__
        """
    ...
    def setDepthDiscontinuityRadius(self, _disc_radius): # real signature unknown; restored from __doc__
        """
    ...
    def setLambda(self, _lambda): # real signature unknown; restored from __doc__
        """
    ...
    def setLRCthresh(self, _LRC_thresh): # real signature unknown; restored from __doc__
        """
    ...
    def setSigmaColor(self, _sigma_color): # real signature unknown; restored from __doc__
        """
