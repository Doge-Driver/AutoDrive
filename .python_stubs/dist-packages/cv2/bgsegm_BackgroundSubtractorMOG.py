...
class bgsegm_BackgroundSubtractorMOG(BackgroundSubtractor):
    ...
    def getNoiseSigma(self): # real signature unknown; restored from __doc__
        """
    ...
    def setBackgroundRatio(self, backgroundRatio): # real signature unknown; restored from __doc__
        """
    ...
    def setHistory(self, nframes): # real signature unknown; restored from __doc__
        """
    ...
    def setNMixtures(self, nmix): # real signature unknown; restored from __doc__
        """
    ...
    def setNoiseSigma(self, noiseSigma): # real signature unknown; restored from __doc__
        """
