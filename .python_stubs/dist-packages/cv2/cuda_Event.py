...
class cuda_Event(object):
    # no doc
    def elapsedTime(self, start, end): # real signature unknown; restored from __doc__
        """
    ...
    def record(self, stream=None): # real signature unknown; restored from __doc__
        """
        record([, stream]) -> None
        .
        """
