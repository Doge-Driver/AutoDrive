...
class face_MACE(Algorithm):
    # no doc
    def create(self, IMGSIZE=None): # real signature unknown; restored from __doc__
        """
    ...
    def salt(self, passphrase): # real signature unknown; restored from __doc__
        """
    ...
    def same(self, query): # real signature unknown; restored from __doc__
        """
        same(query) -> retval
    ...
    def train(self, images): # real signature unknown; restored from __doc__
        """
        train(images) -> None
