...
class detail_ImageFeatures(object):
    # no doc
    def getKeypoints(self): # real signature unknown; restored from __doc__
        """
        getKeypoints() -> retval
        .
        """
    ...
    img_idx = property(lambda self: object(), lambda self, v: None, lambda self: None)  # default
    """img_idx"""

    img_size = property(lambda self: object(), lambda self, v: None, lambda self: None)  # default
    """img_size"""
