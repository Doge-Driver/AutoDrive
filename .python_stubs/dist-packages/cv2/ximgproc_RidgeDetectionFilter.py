...
class ximgproc_RidgeDetectionFilter(Algorithm):
    # no doc
    def create(self, ddepth=None, dx=None, dy=None, ksize=None, out_dtype=None, scale=None, delta=None, borderType=None): # real signature unknown; restored from __doc__
        """
    ...
    def getRidgeFilteredImage(self, _img, out=None): # real signature unknown; restored from __doc__
        """
