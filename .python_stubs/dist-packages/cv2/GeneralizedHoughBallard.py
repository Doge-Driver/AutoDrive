...
class GeneralizedHoughBallard(GeneralizedHough):
    ...
    def getVotesThreshold(self): # real signature unknown; restored from __doc__
        """
    ...
    def setVotesThreshold(self, votesThreshold): # real signature unknown; restored from __doc__
        """
