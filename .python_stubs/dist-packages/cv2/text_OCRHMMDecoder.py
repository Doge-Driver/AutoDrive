...
from .text_BaseOCR import text_BaseOCR

class text_OCRHMMDecoder(text_BaseOCR):
    # no doc
    def create(self, classifier, vocabulary, transition_probabilities_table, emission_probabilities_table, mode=None): # real signature unknown; restored from __doc__
        """
