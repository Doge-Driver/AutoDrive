...
from .quality_QualityBase import quality_QualityBase
...
class quality_QualityPSNR(quality_QualityBase):
    ...
    def compute(self, cmp): # real signature unknown; restored from __doc__
        """
        compute(cmp) -> retval
    ...
    def create(self, ref, maxPixelValue=None): # real signature unknown; restored from __doc__
        """
    ...
    def getMaxPixelValue(self): # real signature unknown; restored from __doc__
        """
    ...
    def setMaxPixelValue(self, val): # real signature unknown; restored from __doc__
        """
