...
from .ShapeDistanceExtractor import ShapeDistanceExtractor

class ShapeContextDistanceExtractor(ShapeDistanceExtractor):
    # no doc
    def getAngularBins(self): # real signature unknown; restored from __doc__
        """
    ...
    def getBendingEnergyWeight(self): # real signature unknown; restored from __doc__
        """
    ...
    def getCostExtractor(self): # real signature unknown; restored from __doc__
        """
    ...
    def getImageAppearanceWeight(self): # real signature unknown; restored from __doc__
        """
    ...
    def getImages(self, image1=None, image2=None): # real signature unknown; restored from __doc__
        """
    ...
    def getInnerRadius(self): # real signature unknown; restored from __doc__
        """
    ...
    def getOuterRadius(self): # real signature unknown; restored from __doc__
        """
    ...
    def getRadialBins(self): # real signature unknown; restored from __doc__
        """
    ...
    def getRotationInvariant(self): # real signature unknown; restored from __doc__
        """
    ...
    def getShapeContextWeight(self): # real signature unknown; restored from __doc__
        """
    ...
    def getStdDev(self): # real signature unknown; restored from __doc__
        """
        getStdDev() -> retval
        .
        """
    ...
    def getTransformAlgorithm(self): # real signature unknown; restored from __doc__
        """
    ...
    def setAngularBins(self, nAngularBins): # real signature unknown; restored from __doc__
        """
    ...
    def setBendingEnergyWeight(self, bendingEnergyWeight): # real signature unknown; restored from __doc__
        """
    ...
    def setCostExtractor(self, comparer): # real signature unknown; restored from __doc__
        """
    ...
    def setImageAppearanceWeight(self, imageAppearanceWeight): # real signature unknown; restored from __doc__
        """
    ...
    def setImages(self, image1, image2): # real signature unknown; restored from __doc__
        """
    ...
    def setInnerRadius(self, innerRadius): # real signature unknown; restored from __doc__
        """
    ...
    def setIterations(self, iterations): # real signature unknown; restored from __doc__
        """
    ...
    def setOuterRadius(self, outerRadius): # real signature unknown; restored from __doc__
        """
    ...
    def setRadialBins(self, nRadialBins): # real signature unknown; restored from __doc__
        """
    ...
    def setRotationInvariant(self, rotationInvariant): # real signature unknown; restored from __doc__
        """
    ...
    def setShapeContextWeight(self, shapeContextWeight): # real signature unknown; restored from __doc__
        """
    ...
    def setStdDev(self, sigma): # real signature unknown; restored from __doc__
        """
    ...
    def setTransformAlgorithm(self, transformer): # real signature unknown; restored from __doc__
        """
