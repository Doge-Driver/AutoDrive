...
class ximgproc_segmentation_GraphSegmentation(Algorithm):
    ...
    def processImage(self, src, dst=None): # real signature unknown; restored from __doc__
        """
    ...
    def setMinSize(self, min_size): # real signature unknown; restored from __doc__
        """
    ...
    def setSigma(self, sigma): # real signature unknown; restored from __doc__
        """
        setSigma(sigma) -> None
        .
        """
