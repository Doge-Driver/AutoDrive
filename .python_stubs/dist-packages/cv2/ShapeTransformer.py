...
class ShapeTransformer(Algorithm):
    # no doc
    def applyTransformation(self, input, output=None): # real signature unknown; restored from __doc__
        """
    ...
    def estimateTransformation(self, transformingShape, targetShape, matches): # real signature unknown; restored from __doc__
        """
    ...
    def warpImage(self, transformingImage, output=None, flags=None, borderMode=None, borderValue=None): # real signature unknown; restored from __doc__
        """
