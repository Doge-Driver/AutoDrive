...
from .face_FaceRecognizer import face_FaceRecognizer

class face_BasicFaceRecognizer(face_FaceRecognizer):
    # no doc
    def getEigenValues(self): # real signature unknown; restored from __doc__
        """
    ...
    def getEigenVectors(self): # real signature unknown; restored from __doc__
        """
    ...
    def getNumComponents(self): # real signature unknown; restored from __doc__
        """
    ...
    def getProjections(self): # real signature unknown; restored from __doc__
        """
    ...
    def setNumComponents(self, val): # real signature unknown; restored from __doc__
        """
