...
class ximgproc_StructuredEdgeDetection(Algorithm):
    # no doc
    def computeOrientation(self, _src, _dst=None): # real signature unknown; restored from __doc__
        """
    ...
    def detectEdges(self, _src, _dst=None): # real signature unknown; restored from __doc__
        """
    ...
    def edgesNms(self, edge_image, orientation_image, _dst=None, r=None, s=None, m=None, isParallel=None): # real signature unknown; restored from __doc__
        """
