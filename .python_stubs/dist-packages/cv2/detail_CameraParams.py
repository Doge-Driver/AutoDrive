...
class detail_CameraParams(object):
    # no doc
    def K(self): # real signature unknown; restored from __doc__
        """
        K() -> retval
        .
        """
    ...
    focal = property(lambda self: object(), lambda self, v: None, lambda self: None)  # default
    """focal"""

    ppx = property(lambda self: object(), lambda self, v: None, lambda self: None)  # default
    """ppx"""

    ppy = property(lambda self: object(), lambda self, v: None, lambda self: None)  # default
    """ppy"""
