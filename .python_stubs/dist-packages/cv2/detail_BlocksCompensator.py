...
from .detail_ExposureCompensator import detail_ExposureCompensator
...
class detail_BlocksCompensator(detail_ExposureCompensator):
    ...
    def getMatGains(self, umv=None): # real signature unknown; restored from __doc__
        """
        getMatGains([, umv]) -> umv
        .
        """
    ...
    def getNrFeeds(self): # real signature unknown; restored from __doc__
        """
        getNrFeeds() -> retval
        .
        """
    ...
    def getNrGainsFilteringIterations(self): # real signature unknown; restored from __doc__
        """
    ...
    def setBlockSize(self, width, height): # real signature unknown; restored from __doc__
        """
    ...
    def setMatGains(self, umv): # real signature unknown; restored from __doc__
        """
    ...
    def setNrFeeds(self, nr_feeds): # real signature unknown; restored from __doc__
        """
    ...
    def setNrGainsFilteringIterations(self, nr_iterations): # real signature unknown; restored from __doc__
        """
