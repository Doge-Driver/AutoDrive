...
from .CalibrateCRF import CalibrateCRF
...
class CalibrateDebevec(CalibrateCRF):
    ...
    def getRandom(self): # real signature unknown; restored from __doc__
        """
        getRandom() -> retval
        .
        """
    ...
    def setLambda(self, lambda_): # real signature unknown; restored from __doc__
        """
    ...
    def setRandom(self, random): # real signature unknown; restored from __doc__
        """
