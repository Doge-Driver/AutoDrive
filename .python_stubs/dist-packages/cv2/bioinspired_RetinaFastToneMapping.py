...
class bioinspired_RetinaFastToneMapping(Algorithm):
    ...
    def setup(self, photoreceptorsNeighborhoodRadius=None, ganglioncellsNeighborhoodRadius=None, meanLuminanceModulatorK=None): # real signature unknown; restored from __doc__
        """
