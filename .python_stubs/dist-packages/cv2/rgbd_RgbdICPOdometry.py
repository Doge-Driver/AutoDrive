...
class rgbd_RgbdICPOdometry(rgbd_Odometry):
    # no doc
    def create(self, cameraMatrix=None, minDepth=None, maxDepth=None, maxDepthDiff=None, maxPointsPart=None, iterCounts=None, minGradientMagnitudes=None, transformType=None): # real signature unknown; restored from __doc__
        """
    ...
    def getNormalsComputer(self): # real signature unknown; restored from __doc__
        """
