...
class flann_Index(object):
    # no doc
    def build(self, features, params, distType=None): # real signature unknown; restored from __doc__
        """
    ...
    def knnSearch(self, query, knn, indices=None, dists=None, params=None): # real signature unknown; restored from __doc__
        """
    ...
    def load(self, features, filename): # real signature unknown; restored from __doc__
        """
    ...
    def radiusSearch(self, query, radius, maxResults, indices=None, dists=None, params=None): # real signature unknown; restored from __doc__
        """
