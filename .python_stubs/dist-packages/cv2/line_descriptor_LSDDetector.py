...
class line_descriptor_LSDDetector(Algorithm):
    # no doc
    def createLSDDetector(self): # real signature unknown; restored from __doc__
        """
    ...
    def createLSDDetectorWithParams(self, params): # real signature unknown; restored from __doc__
        """
    ...
    def detect(self, image, scale, numOctaves, mask=None): # real signature unknown; restored from __doc__
        """
