...
class xphoto_TonemapDurand(Tonemap):
    ...
    def getSaturation(self): # real signature unknown; restored from __doc__
        """
    ...
    def getSigmaSpace(self): # real signature unknown; restored from __doc__
        """
    ...
    def setSigmaColor(self, sigma_color): # real signature unknown; restored from __doc__
        """
    ...
    def setSigmaSpace(self, sigma_space): # real signature unknown; restored from __doc__
        """
